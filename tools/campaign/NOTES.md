...
### m1 护送关（✅ 现行录制 WIN ticks=5172，2026-09-06 r68 环路重录；旧砍树墙录制 392912 留档 recordings/campaign/m1-chop/）
- **环路配方（r68，移植 player-ai CampaignAi v2 20/20）**：PH0 清口袋 12 格敌
  （实测恒空——锚 (31,58) 12 格内无敌，sweep 前两点覆盖）→ 军事沿 SWEEP 11 点
  集火推进 (16,54)(15,47)(23,27)(25,21)(32,17)(37,22)(49,24)(54,19)(49,33)
  (61,45)(60,55)，村民钉口袋围栏 → 只送 slot0 沿 WALK 15 点 (27,54)(18,55)
  (19,46)(19,36)(23,30)(26,23)(31,18)(38,21)(47,22)(51,28)(60,29)(60,39)
  (60,49)(56,55)(53,60)，军事拖后一点保镖，到位静止收尾。首发 WIN@5172
  （旧配方快 76×），歼敌 14/16、村民零伤亡、损 2×t3（合法）。
- **塔程勘误（r68，修正本档案旧记录）**：塔射程 √5/hdr[12]=5 旧记作废——
  spawnMission 不写 hdr[12]（c.java:4423 任务装载默认 16，科技才升 25/36），
  **塔程²=16**。敌塔实位=(48,50)(50,50)(49,52)+中岛(36,37)+西塔(16,36)
  （aistate buildingRecs 真值；CampaignAi 注释与简报的 (50,48)(52,49)(50,50)
  是 mapdump 建筑层转置 bug 时代坐标——**凡引用文档级塔坐标一律先 aistate
  对账**）。弹道落点是瞄准时刻快照格（c.java:8242），移动单位穿塔程大概率
  白过（WALK[3] 在西塔程内未掉血实证）。
- 以下为旧砍树墙配方档案（历史样本，唯一"砍隧道"实证）：
