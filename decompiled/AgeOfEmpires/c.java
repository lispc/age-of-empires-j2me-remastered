...
import AgeOfEmpires.AgeOfEmpires;
...
implements CommandListener {
    public AgeOfEmpires var_AgeOfEmpires_AgeOfEmpires_a;
    public int aO;
    ...
    c(AgeOfEmpires ageOfEmpires) {
        super(ageOfEmpires, 134, 0);
        this.var_AgeOfEmpires_AgeOfEmpires_a = ageOfEmpires;
    ...
    public final void w() {
        if (this.var_boolean_e) {
            this.var_AgeOfEmpires_AgeOfEmpires_a.a();
        }
    }

    public final synchronized void k() {
        if (this.ar < 20 || !AgeOfEmpires.var_boolean_a) {
            return;
        }
        this.af = 0;
    ...
    public final void h() {
        ((com.ulysseo.mad.b)((Object)var_AgeOfEmpires_AgeOfEmpires_a)).a();
    }
    ...
    public final int int_b() {
        ...
        this.ay = -2;
        this.var_int_f = 19;
        this.m(var_AgeOfEmpires_AgeOfEmpires_a.getWidth(), var_AgeOfEmpires_AgeOfEmpires_a.getHeight());
    ...
    public final void void_b() {
        ((com.ulysseo.mad.b)((Object)var_AgeOfEmpires_AgeOfEmpires_a)).b();
        var_AgeOfEmpires_AgeOfEmpires_a.setFullScreenMode(true);
        while (!var_AgeOfEmpires_AgeOfEmpires_a.isShown()) {
        }
        var_AgeOfEmpires_AgeOfEmpires_a.setCommandListener(this);
        var_AgeOfEmpires_AgeOfEmpires_a.getWidth();
        var_AgeOfEmpires_AgeOfEmpires_a.getHeight();
        ((com.ulysseo.mad.b)((Object)var_AgeOfEmpires_AgeOfEmpires_a)).a(80, 1);
    }
        ...
        if (n == 0) {
            ...
            switch (this.H) {
                ...
                case 11: {
                    ...
                    this.var_byte_arr_i[n2 + 1] = (byte)(this.aG + 1);
                ...
                case 12: {
                    ...
                    this.var_byte_arr_i[n3 + 1] = (byte)(this.aj + 1);
    ...
    public final boolean boolean_c(int n) {
        ...
        if (this.aF != 0) {
            object = com.ulysseo.mad.c.byte_arr_a(this.aF);
            this.var_boolean_k = false;
            int n2 = object[0] & 0xFF;
            int n3 = object[1] & 0xFF;
            if ((n2 | n3) != 0) {
                var_int_k = n2;
                r = n3;
            } else {
    ...
    final boolean boolean_b(int n, int n2) {
        ...
        if ((this.var_short_arr_a[n3 + (n5 << 6)] & 0xFFF) != 0 || n16 == s) {
            ...
            for (n17 = 0; n17 < 7; ++n17) {
                ...
                if ((((n21 = n3 + this.var_byte_arr_g[by = this.var_byte_arr_g[n20++]]) | n22) & 0xFFFFFFC0) != 0 || (this.var_short_arr_a[n21 + (n22 << 6)] & 0xFFF) != 0 || (n21 << 8 | n22) == s) continue;
                n3 = n21;
                n5 = n22;
    ...
    final void z() {
        ...
        if (this.var_int_i != 0) {
            ...
            if (n3 >= 0) {
                ...
                while (n < n4) {
                    if ((this.var_short_arr_arr_a[1][n6 + 3] & 0xFF) >= 2 && (this.var_short_arr_arr_a[1][n6 + 7] & 0xF) != 1) {
                        this.var_short_arr_arr_a[1][n6 + 2] = n3;
                    }
                    ++n;
                    n6 += 8;
                }
            ...
            if (n2 >= 0) {
                ...
                while (n < n5) {
                    if ((this.var_short_arr_arr_a[1][n6 + 3] & 0xFF) >= 2 && (this.var_short_arr_arr_a[1][n6 + 7] & 0xF) != 1) {
                        this.var_short_arr_arr_a[1][n6 + 2] = n2;
                    }
                    ++n;
                    n6 += 8;
                }
        ...
        block13: while (true) {
            switch (this.var_byte_arr_a[n++]) {
                ...
                case 1: {
                    ...
                    this.var_byte_arr_a[n5] = -this.var_byte_arr_a[n5];
                    break;
                }
                case 4: {
                    ++n;
