...
4. **Easy 原版阈值攻坚（2026-09-06 新开放）**：Easy 进攻阈值恢复原版 50
   （曾 200 平衡实验，e3747d3），RuleBasedAi 首批 0/5、全灭于 ~2.5k tick
   （敌 75% 兵力 all-in ~2.2k 到家，塔防节奏按 200 时代调的跟不上）。方向=
   波 1 前军事化（兵营早开+长枪 1-2 个顶门口）、TC 拉扯（v35 波 1 微操
   复用）、或率先拆敌兵营。基线已录 WORKLOG 第 39 夜。
