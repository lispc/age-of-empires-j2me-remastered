...
- 【已验证，m4 七轮实战】**村民由 House(type11) 训练，TC 不生产任何单位**；
  兵营(type10)产民兵（**占 2 pop**）、House 产村民（1 pop）。「House 先行」的
  真实语义=House 是生产建筑：村民产能=House 数量，TC 被毁不掉产能、House 毁了
  才断（驱动规划 2026-09-04 boot2/3 实训实证 + mocksim handle() 同构）。
